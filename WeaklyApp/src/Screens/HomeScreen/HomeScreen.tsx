    ...
    <SafeAreaView style={HomeStyle.container}>
      <View style={HomeStyle.innerContainer}>
        ...
        <Text style={HomeStyle.text2}>
          Jules Payot : İnsqanlar vazgeçemedikleri arzularının kölesidirler.
          Kimse hak etmediği sürece özgür olamaz.
        </Text>
        <Text style={HomeStyle.text2}>
      ...
      <View style={HomeStyle.buttonContainer}>
        ...
        <TouchableOpacity
          style={HomeStyle.squareButton}
          onPress={() => navigation.navigate('WeekDays')}>
          <Text style={HomeStyle.plus}>Week Days Ekle</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
